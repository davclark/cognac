...
class Response:
    ...
    def __init__(self, label, expected=None, limit=None, buttonbox=None):
        ...
        self.label = label  # use label=None to omit logging (NOT IMPLEMENTED)
...
class Event:
    ...
    def __init__(self, target, start, stop=None, duration=None, on_keypress=False,
...
class StimController:
    ...
    def loglines(self):
        ...
        for t in self.trials:
            ...
            #resps = [event.response for event in t.events \
            #    if event.response.labelx] # if no labeled responses, 
            #events = t.events
            #if not resps:
            #    continue
